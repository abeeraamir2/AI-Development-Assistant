...
export default function RegisterPage({ setAuthToken, setUserRole, setUserEmail, setUserName }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userNameReturned = data.name || name.trim();
      ...
      if (token) {
        ...
        if (setUserName) setUserName(userNameReturned);

        toast.success(`Account created successfully! Welcome to DevAssist, ${userNameReturned}.`);
        navigate("/");
      } else {
