...
export default function GroundedInsightBanner({ projectName = "Project Alpha", relatedCount = 3, onViewSources }) {
  return (
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-[var(--text-muted)] mt-0.5">
            This analysis was informed by {relatedCount} related requirements from {projectName}.
          </p>
        </div>
      </div>
